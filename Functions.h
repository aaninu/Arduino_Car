...
/** First Boot */
void Control_FirstBoot(){
  digitalWrite(PIN_LED_PozitieFata, true);
  delay(100);
  digitalWrite(PIN_LED_FazaLunga, true);
  delay(100);
  digitalWrite(PIN_LED_PozitieSpate, true);
  delay(100);
  digitalWrite(PIN_LED_Stop, true);
  delay(100);
  digitalWrite(PIN_LED_Stanga, true);
  delay(100);
  digitalWrite(PIN_LED_Dreapta, true);
  delay(1000); 
  digitalWrite(PIN_LED_PozitieFata, false);
  digitalWrite(PIN_LED_PozitieSpate, false);
  digitalWrite(PIN_LED_FazaLunga, false);
  digitalWrite(PIN_LED_Stop, false);
...
void Control_Motor_Bottom(){
  if (oMotor_Bottom != Motor_Bottom && !Motor_Left && !Motor_Right){
    ...
    if (Motor_Bottom) LED_Stop = false;
